...
// The slug rules live in a React-free module so plain Node scripts can import
// them; re-exported here because every existing caller reaches for them via the
// read layer.
export {
  isReservedSlug,
  NESTABLE_SLUG_PREFIXES,
  RESERVED_SLUGS,
} from "@/lib/seoteam/page-slug";
